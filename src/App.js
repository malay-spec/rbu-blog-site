...
export default function App() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: C.bg, color: C.text }}>
      {/* Nav */}
      <nav style={{ background: "#ffffff", borderBottom: "2px solid #e8e8e8", padding: "0 24px", position: "sticky", top: 0, zIndex: 100, boxShadow: "0 2px 12px rgba(0,0,0,0.1)" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", height: 70, display: "flex", alignItems: "center", justifyContent: "space-between" }}>

          {/* Left — Sunstone Logo */}
          <button onClick={() => setPage("home")} style={{ background: "none", border: "none", cursor: "pointer", display: "flex", alignItems: "center", gap: 6, flexShrink: 0 }}>
            {/* Sunstone icon — 4 squares matching their actual logo */}
            <svg width="28" height="20" viewBox="0 0 28 20" fill="none">
              <rect x="0" y="0" width="8" height="8" fill="#1a5fb4" rx="0.5"/>
              <rect x="10" y="0" width="8" height="8" fill="#1a5fb4" rx="0.5"/>
              <rect x="20" y="0" width="8" height="8" fill="#1a5fb4" rx="0.5"/>
              <rect x="0" y="11" width="8" height="8" fill="#1a5fb4" rx="0.5"/>
              <rect x="10" y="11" width="8" height="5" fill="#1a5fb4" rx="0.5"/>
            </svg>
            <span style={{ color: "#1a5fb4", fontWeight: 800, fontSize: 18, fontFamily: "'Outfit',sans-serif", letterSpacing: 2, textTransform: "uppercase" }}>
              SUNSTONE
            </span>
          </button>

          {/* Centre — Riya CTA Button */}
          <a href="https://mohali-alpha.vercel.app" target="_blank" rel="noopener noreferrer"
            style={{ background: "linear-gradient(135deg, #7c3aed, #ef4444)", color: "#fff",
              padding: "10px 22px", borderRadius: 50, fontWeight: 700, fontSize: 14,
              textDecoration: "none", flexShrink: 0, whiteSpace: "nowrap",
              boxShadow: "0 4px 14px rgba(124,58,237,0.4)" }}>
            Chat with Riya 🤖
          </a>

          {/* Right — Alpha School of RBU Logo */}
          <button onClick={() => setPage("home")} style={{ background: "none", border: "none", cursor: "pointer", display: "flex", alignItems: "center", gap: 8, flexShrink: 0 }}>
            {/* Circular badge */}
            <div style={{ width: 46, height: 46, borderRadius: "50%", background: "linear-gradient(135deg, #1a3a6b 0%, #c0392b 100%)", display: "flex", alignItems: "center", justifyContent: "center", border: "2px solid #1a3a6b", flexShrink: 0 }}>
              <div style={{ textAlign: "center" }}>
                <div style={{ color: "#f5c842", fontWeight: 900, fontSize: 8, letterSpacing: 0.5, fontFamily: "serif" }}>RAYAT</div>
                <div style={{ color: "#fff", fontWeight: 900, fontSize: 7, letterSpacing: 0.3 }}>BAHRA</div>
              </div>
            </div>
            <div>
              <div style={{ color: "#c0392b", fontWeight: 900, fontSize: 15, fontFamily: "'Outfit',sans-serif", letterSpacing: 0.5, lineHeight: 1.1 }}>ALPHA</div>
              <div style={{ color: "#1a3a6b", fontWeight: 600, fontSize: 9, letterSpacing: 1, textTransform: "uppercase" }}>SCHOOL OF RBU</div>
            </div>
          </button>
      ...
      <footer style={{ background: C.bgCard, borderTop: `1px solid ${C.border}`, padding: "40px 24px", textAlign: "center" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 32, marginBottom: 20, flexWrap: "wrap" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
            <svg width="22" height="16" viewBox="0 0 28 20" fill="none">
              <rect x="0" y="0" width="8" height="8" fill="#4a90d9" rx="0.5"/>
              <rect x="10" y="0" width="8" height="8" fill="#4a90d9" rx="0.5"/>
              <rect x="20" y="0" width="8" height="8" fill="#4a90d9" rx="0.5"/>
              <rect x="0" y="11" width="8" height="8" fill="#4a90d9" rx="0.5"/>
              <rect x="10" y="11" width="8" height="5" fill="#4a90d9" rx="0.5"/>
            </svg>
            <span style={{ color: "#4a90d9", fontWeight: 800, fontSize: 14, fontFamily: "'Outfit',sans-serif", letterSpacing: 2 }}>SUNSTONE</span>
          </div>
          <div style={{ width: 1, height: 24, background: "rgba(255,255,255,0.15)" }} />
          {/* Alpha School of RBU */}
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <div style={{ width: 34, height: 34, borderRadius: "50%", background: "linear-gradient(135deg, #1a3a6b, #c0392b)", display: "flex", alignItems: "center", justifyContent: "center" }}>
              <span style={{ color: "#fff", fontWeight: 900, fontSize: 8 }}>RBU</span>
            </div>
            <div>
              <div style={{ color: "#c0392b", fontWeight: 900, fontSize: 13, fontFamily: "'Outfit',sans-serif", lineHeight: 1.1 }}>ALPHA</div>
              <div style={{ color: "rgba(255,255,255,0.5)", fontWeight: 600, fontSize: 8, letterSpacing: 1 }}>SCHOOL OF RBU</div>
            </div>
          </div>
        </div>
        ...
        <div style={{ color: C.textDim, fontSize: 13, marginBottom: 12 }}>Powered by Sunstone • BTech CSE & BCA Admissions Open 2026</div>
